...
--> JOB.CODE 컬럼명이 같아서 어떤 테이블의 컬럼인지 구분할 수 없기 때문에
...
SELECT 
	EMP_ID 사번, 
	EMP_NAME 이름, 
	E.JOB_CODE 직급코드, -- 어떤 테이블의 컬럼을 조회할지 별칭을 작성 
	JOB_NAME 직급명
...
-- 2) DEPARTMENT(LOCATION_ID), LACATION(LOCAL_CODE) JOIN
