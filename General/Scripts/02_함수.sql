...
-- 문자열에서 5번부터 검색 시작해서 처음 찾은 'B'으; 위치 조회
...
SELECT 
	...
	TRUNC(123.456, 2)-- 123.4 (셋째 자리부터 버림)
FROM DUAL;
...
---> 년,월,일,시,분,초는 시간 관련 기호는 인식되지 않아서 오류 발생!!
...
-- 50 이상 확인
SELECT 
	TO_DATE('55-12-25', 'YY-MM-DD'), -- 2055
	TO_DATE('55-12-25', 'RR-MM-DD')  -- 1955
FROM DUAL;
